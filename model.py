...
def model ():
    ...
    train_data, train_label, ch_train = get_data(filename="./RawData/UCI HAR Dataset/", type="train")
    test_data, test_label,ch_test = get_data(filename="./RawData/UCI HAR Dataset/", type="test")
    ...
    model = tf.keras.models.Sequential([tf.keras.layers.Conv2D(filters=32,kernel_size=(2,2), activation='relu', input_shape=X_train[0].shape),
